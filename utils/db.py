...
class ParseSubjects:
      ...
      def clean_file(self):
            ...
            try:
                  ...
                  raise ValueError(f"Check column names - we need the following: {column_targets}")
            ...
            file["phone_number"] = file["phone_number"].apply(lambda x: clean_phone_number(x))
      ...
      def run(self):
            ...
            with sqlite3.connect(self.database_path) as connection:
                  ...
                  for ix, name in enumerate(file["subject_name"]):
                        ...
                        self.push_to_database(cursor=cursor, name=name,
                                              number=phone, date=date)
